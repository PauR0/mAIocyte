...
#FILE_DIR = sys.path[0]
FILE_DIR = '/Users/pau/Electrophys/StemCells'
#--------------------------------------------------------
#EPI AP curves data sets
#--------------------------------------------------------
